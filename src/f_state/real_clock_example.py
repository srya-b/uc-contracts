...
for pid,p2g,p2bc in zip(statepartyids,p2ledgers,p2bcs):
    prots.append(State_Protocol(statesid, pid, ledger_itm, bc_itm, caddr2, caddr1, U1, p2g, p2bc, *statepartyids))
rparties = []
...
z_ping(z2p1); z_ping(z2p2); z_ping(z2p3);
z_inputs(('clock-update',), z2p1, z2p2, z2p3)
##z_mine_blocks(1, z2sp, z2sp.to)
z_ping(a2bc); z_ping(z2p1); z_ping(z2p2); z_ping(z2p3);
z_inputs(('clock-update',), z2p1, z2p2, z2p3)
z_ping(a2bc); z_ping(z2p1); z_ping(z2p2); z_ping(z2p3);
...
z_inputs(('input','add', 2), z2p1)
z_inputs(('input','add', 2), z2p2)
...
z_ping(a2bc); z_ping(z2p1); z_ping(z2p2); z_ping(z2p3)
z_inputs(('clock-update',), z2p1, z2p2, z2p3)
z_inputs( ('write', p2ledger1, ('transfer', aux_caddr, 0, ('mult', (2,)), 'doesnt matter')), z2p1)
z_inputs( ('write', p2ledger2, ('transfer', aux_caddr, 0, ('mult', (10,)), 'doesnt matter')), z2p2)
z_inputs( ('write', p2ledger3, ('transfer', aux_caddr, 0, ('mult', (10,)), 'doesnt matter')), z2p3)
z_set_delays(z2a, advitm, ledger_itm, [0,0,0])
z_mine_blocks(1, z2sp, z2sp.to)
z_ping(a2bc); z_ping(z2p1); z_ping(z2p2); z_ping(z2p3);
p1r = z_read(p1id,rparties[0])
p2r = z_read(p2id,rparties[1])
...
z_inputs(('input','sub', 3), z2p1)
z_inputs(('input','sub', 3), z2p2)
z_inputs(('input','sub', 3), z2p3)
z_ping(z2p1); z_ping(z2p2); z_ping(z2p3);
z_inputs(('clock-update',), z2p1, z2p2, z2p3)
####z_mine_blocks(1, z2sp, z2sp.to)
z_ping(a2bc); z_ping(z2p1); z_ping(z2p2); z_ping(z2p3);
...
z_inputs(('input','sub', 4), z2p1)
z_inputs(('input','sub', 4), z2p2)
z_inputs(('input','sub', 4), z2p3)
z_ping(z2p1); z_ping(z2p2); z_ping(z2p3);
z_inputs(('clock-update',), z2p1, z2p2, z2p3)
####z_mine_blocks(1, z2sp, z2sp.to)
z_ping(a2bc); z_ping(z2p1); z_ping(z2p2); z_ping(z2p3)
...
z_inputs( ('call-evidence',4), z2p2)
z_inputs( ('write', p2ledger2, ('transfer', state_caddr, 0, ('dispute', (5,)), 'doesntmatter')), z2p2)
z_set_delays(z2a, advitm, ledger_itm, [0,0])
z_mine_blocks(1, z2sp, z2sp.to)

z_inputs(('input','add', 5), z2p1)
z_inputs(('input','add', 5), z2p2)
z_inputs(('input','sub', 5), z2p3)
z_inputs(('clock-update',5), z2p1, z2p2, z2p3)
####z_mine_blocks(1, z2sp, z2sp.to)
z_ping(a2bc)
z_ping(z2p1)
z_ping(z2p2)
