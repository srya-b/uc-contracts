...
class OnlineMPCProtocol(UCAsyncWrappedProtocol):
        ...
        def compute_actions(self):
            ...
            if type == TransitionType.MULT:
                ...
                if self.step1 is False:
                    self.step1 = True
                    self.prot.write('p2f', ((self.prot.get_sid(Functionalities.F_OFFLINE), Functionalities.F_OFFLINE), (MessageTag.TRIPLE, (self.id, self.transition_count, outvar))))
                    m = wait_for(self.prot.f2p)
    ...
    def __init__(self, sid, pid, channels, pump):
        ...
        self.contract_handlers = defaultdict(lambda: self.ContractHandler(self))
        self.pump = pump
        UCAsyncWrappedProtocol.__init__(self, sid, pid, channels)
        ...
        if func[1] == Functionalities.F_ATOMIC:
            ...
            for tx in BC[len(self.BC):]:
                ...
                if tx[0] == MessageTag.INPUT_VAL:
                    ...
                    self.write('p2f', ((self.get_sid(Functionalities.F_OFFLINE), Functionalities.F_OFFLINE), (MessageTag.LABEL, label)))
                    ...
                    input_msg = (MessageTag.DEFINED_VAR, (var_name, contract_id))
                ...
                if tx[0] == MessageTag.CREATE_CONTRACT:
                    ...
                    if issubclass(contract_class, Contract):
                        ...
                        contract_msg = (MessageTag.DEFINED_CONTRACT, (contract_class, contract_id))
