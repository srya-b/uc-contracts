...
class AsyncWrapper(ITM):
    def __init__(self, sid, pid, channel_wrapper):
        ...
        self.z2w = channel_wrapper.getChannel('z2w')
        self.a2w = channel_wrapper.getChannel('a2w')
        self.w2f = channel_wrapper.getChannel('w2f')
        self.w2z = channel_wrapper.getChannel('w2z')
        self.w2a = channel_wrapper.getChannel('w2a')
