...
import comm
import gevent
from itm import ITMFunctionality, ITMPassthrough, ITMAdversary, createParties, ITMPrinterAdversary, ITMProtocol, DefaultSim
...
#from f_state/f_state import StateChannel_Functionality, StateITM, Sim_State
...
# Parties
iparties = z_ideal_parties(fstatesid, fstatepartyids, ledger_itm, createParties, [a2p1,a2p2,a2p3], [p2ledger1,p2ledger2,p2ledger3], [z2p1,z2p2,z2p3])
comm.setParties(iparties)
p1 = iparties[0]; p2 = iparties[1]; p3 = iparties[2]
# Simulator
#simulator = Sim_State(advid[0], advid[1], ledger_itm, ledger_itm, p2, None, a2p2, a2ledger)
simulator = DefaultSim(advid[0], advid[1], ledger_itm, a2ledger)
...
balance = p1.subroutine_call(('getbalance',p1.sender))
print('p1 balance', balance)
balance = p1.subroutine_call(('getbalance',p2.sender))
print('p2 balance', balance)
balance = p1.subroutine_call(('getbalance',p3.sender))
print('p3 balance', balance)
