...
Users deposit
'''
z_instant_input(z2p1, ('deposit',10))
z_instant_input(z2p2, ('deposit', 10))
...
z_mine_blocks(1, z2sp, z2sp.to)
z_ping(z2p1)
p1read = z_read(p1id,p1)
if p1read: print('p1', p1read, '\n')
z_ping(z2p2)
p2read = z_read(p2id,p2)
if p2read: print('p1', p2read, '\n')
####
