...
from uc.itm import WrappedPartyWrapper, PartyWrapper
...
if __name__=='__main__':
    ...
    execWrappedUC(128, env1, [('F_bracha',Syn_Bracha_Functionality)], WrappedPartyWrapper, Syn_FWrapper, 'F_bracha', RBC_Simulator)
